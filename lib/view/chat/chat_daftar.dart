...
import 'package:bst/model/model%20chat/create_consultation.dart';
import 'package:bst/view/chat/chat.dart';
  ...
  if (nohp != null || nohp != "") {
    ...
    if (res?.response == "true") {
      Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(
              builder: (context) => Chat(ConsultationID: res!.ConsultationID)),
